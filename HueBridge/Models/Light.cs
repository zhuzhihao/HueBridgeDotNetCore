...
namespace HueBridge.Models
{
    public class Light
    {
        ...
        public bool LuminaireUniqueId { get; set; } // Unique ID of the luminaire the light is a part of in the format: AA:BB:CC:DD-XX-YY.  AA:BB:, ... represents the hex of the luminaireid,
    ...
    public class LightState
    {
        ...
        public float[] XY { get; set; }         // The x and y coordinates of a color in CIE color space.
        ...
        public string Alert { get; set; }       // “none” – The light is not performing an alert effect.
                                                // “select” – The light is performing one breathe cycle.
                                                // “lselect” – The light is performing breathe cycles for 15 seconds or until an "alert": "none" command is received.
        public string Effect { get; set; }      // The dynamic effect of the light, can either be “none” or “colorloop”.
        public string ColorMode { get; set; }   // Values are “hs” for Hue and Saturation, “xy” for XY and “ct” for Color Temperature. This parameter is only present when the light supports at least one of the values.
